...
# 加载图像
blue_marble = Image.open("gebco.png")
...
output_image_north = cp.ones((height, width, 3), dtype=cp.uint8) * 255
output_image_south = cp.ones((height, width, 3), dtype=cp.uint8) * 255
...
output_image_north[north_proj_y, north_proj_x] = blue_marble_array[north_mask]
output_image_south[south_proj_y, south_proj_x] = blue_marble_array[south_mask]
